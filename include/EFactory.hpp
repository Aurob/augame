...
void makePlayer(entt::registry& registry) {
    ...
    registry.emplace_or_replace<Shape>(player, Shape{pw, ph});
    registry.emplace_or_replace<Color>(player, Color{0, 0, 255, 0.0f});
    registry.emplace_or_replace<Movement>(player, Movement{100, 1000, Vector2f{0, 0}, Vector2f{0, 0}, 10, 1, 0});
    ...
    registry.emplace_or_replace<TickAction>(player, TickAction{
...
Color color, entt::entity parent = entt::null, bool createDoor = false, int priority = 0, int doorPosition = 0) {
    ...
    registry.emplace_or_replace<Shape>(room, Shape{width, height});
    ...
    auto createWall = [&](float posX, float posY, float posZ, float shapeWidth, 
        ...
        registry.emplace_or_replace<Shape>(wall, Shape{shapeWidth, shapeHeight});
...
void runFactories(entt::registry& registry) {
    // Get player position and shape
    int playerPriority = registry.get<RenderPriority>(_player).priority;
    ...
    auto outerRoom = createRoom(registry, -20, -20, 0.0f, 25, 25, Color{180, 180, 180, 1.0f}, entt::null, true, 0, rand() % 4 + 1);
    ...
    registry.emplace_or_replace<Position>(door, Position{doorX, doorY - doorHeight, 0});
    registry.emplace_or_replace<Shape>(door, Shape{doorWidth, doorHeight});
    ...
    registry.emplace_or_replace<Position>(doorTexture, Position{doorX, doorY - 2, 0});
    ...
    registry.emplace_or_replace<Position>(innerDoor, Position{doorX, doorY, 0});
    registry.emplace_or_replace<Shape>(innerDoor, Shape{1.5, 2});
    ...
    registry.emplace_or_replace<Position>(innerDoorTexture, Position{doorX, doorY, 0});
    registry.emplace_or_replace<Shape>(innerDoorTexture, Shape{1, 2});
    ...
    registry.emplace_or_replace<Position>(innerDoor2, Position{doorX, doorY, 0});

...
var ASM_CONSTS = {
  9210553: ($0, $1) => { Module.setkv(UTF8ToString($0), $1); },  
 9210593: ($0) => { Module.speak(UTF8ToString($0)) },  
 9210627: ($0) => { console.log(UTF8ToString($0)); },  
 9210662: () => { Module.ready(); },  
 9210682: ($0) => { Module.show_alert(UTF8ToString($0)); },  
 9210723: () => { Module.fetch_configs(); },  
 9210751: ($0, $1, $2) => { Module.update_color($0, $1, $2); },  
 9210788: ($0, $1) => { Module.update_user_position($0, $1); },  
 9210829: ($0) => { var str = UTF8ToString($0) + '\n\n' + 'Abort/Retry/Ignore/AlwaysIgnore? [ariA] :'; var reply = window.prompt(str, "i"); if (reply === null) { reply = "i"; } return allocate(intArrayFromString(reply), 'i8', ALLOC_NORMAL); },  
 9211054: () => { if (typeof(AudioContext) !== 'undefined') { return true; } else if (typeof(webkitAudioContext) !== 'undefined') { return true; } return false; },  
 9211201: () => { if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return true; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return true; } return false; },  
 9211435: ($0) => { if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } if (SDL2.audioContext) { if ((typeof navigator.userActivation) === 'undefined') { autoResumeAudioContext(SDL2.audioContext); } } } return SDL2.audioContext === undefined ? -1 : 0; },  
 9211987: () => { var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate; },  
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 8927656;
...
function invoke_iiififf(index,a1,a2,a3,a4,a5,a6) {
  var sp = stackSave();
  try {
    return getWasmTableEntry(index)(a1,a2,a3,a4,a5,a6);
  } catch(e) {

...
var ASM_CONSTS = {
 ...
 988423: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 988506: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 988575: () => { return window.innerWidth; },  
 988605: () => { return window.innerHeight; }
};
